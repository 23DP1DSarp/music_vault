...
const register = async (payload: RegisterForm) => {
    try {
        ...
        console.error(error);
        form.value.error = 'Регистрация не удалась. Попробуйте снова.';
    }
};
...
<body>
    <nav>
        <div id="logo">
            ...
            <p><RouterLink to="/ru">MusicVault</RouterLink></p>
        </div>
        <RouterLink to="/ru/login">Войти</RouterLink>
    ...
    <main>
            ...
            <form id="sign_up_form" @submit.prevent="register(form)"  method="post">
                ...
                <div class="form_parts">
                    <input id="submit_btn" type="submit" value="Регистрация">
                </div>
        ...
        <div id="footer_top">
            <div id="footer_info">
                ...
                <p id="footer_info_text">
                    Ваш главный ресурс для музыкальных записей. Открывайте,
                    коллекционируйте и наслаждайтесь музыкой так, как она должна быть
                    услышана.
                </p>
            ...
            <div id="subscribe_form">
                <h6>Оставайтесь в курсе</h6>
                <p>Получайте уведомления о новых релизах и эксклюзивных предложениях.</p>

                <form action="" method="post">
                    <input id="email_input" placeholder="Введите ваш email" name="subscription-email" type="email" required>
